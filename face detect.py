...
def detectFace(img, cascade):
    ...
    small_img = cv.CreateImage((cv.Round(img.width / imageScale),
        cv.Round(img.height / imageScale)), 8, 1)
...
if __name__ == '__main__':
    ...
    # command line argument: python face detect.py path    #if len(sys.argv) != 2:
    #    print 'please provide a directory to read'
    #    sys.exit(1)
    #readDirectory(sys.argv[1], cascade)
    readDirectory('/home/pi/Documents/raspberrypi-app/haar', cascade)
